...
The `model` function acts as a [hook](https://guides.emberjs.com/release/getting-started/core-concepts/#toc_hooks), meaning that Ember will call it for us during different times in our app.
