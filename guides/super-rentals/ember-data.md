...
Delete the hard-coded JavaScript Array, and replace it with the following call to the [Ember Data Store service](https://guides.emberjs.com/release/models/#toc_the-store-and-a-single-source-of-truth).
